...
[^2]: Compare with statements by Christina Young published in context of the 2003 Alternatives to Lining Conference ({% cite 'Young 2003' '55–56' %}), as well as {% cite 'Flock 2014' %}, {% cite 'Flock 2020' %}, {% cite 'Flock et al. 2021' %},  and {% cite 'Flock et al. 2022' %}.
...
[^8]: Compare to {% cite 'Flock 2014' %}; {% cite 'Flock et al. 2019' %}; and {% cite 'Flock et al. 2021' %}.

[^9]: For more details on scale effects, see, for example, {% cite 'Flock 2020' '51, 55' %}; {% cite 'Flock et al. 2021' %}; and {% cite 'Flock 2014' '130–39' %}.
