...
{% figure 'fig-28-3' 'pdf-two-column pdf-float-top' %}

{% figure 'fig-28-4' 'pdf-no-top-border pdf-float-top' %}

{% figure 'fig-28-5' 'pdf-two-column pdf-float-top' %}
...
{% figure 'fig-28-6' 'pdf-no-top-border' %}
