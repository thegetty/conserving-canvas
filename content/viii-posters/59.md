...
{% figure 'fig-59-1' 'pdf-two-column pdf-float-top' %}
...
{% figuregroup '3' 'fig-59-2-a, fig-59-2-b, fig-59-2-c' '**Figure 59.2** (a) Thread-by-thread suture. (b) Textile intarsia. &#40;c) Reinforcement with thread bridges. Image: Emanuel Sterp Moga' 'pdf-two-column pdf-float-top' %}
...
{% figure 'table-59-1' 'pdf-float-top' %}
...
{% figure 'fig-59-3' 'pdf-two-column pdf-float-top pdf-no-bottom-border' %}
...
{% figure 'fig-59-4' 'pdf-two-column pdf-float-top' %}
