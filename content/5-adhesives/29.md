...
{% figure 'table-29-1' 'pdf-float-top' %}
...
{% figure 'table-29-2' 'pdf-float-top' %}
...
[^9]: For more details on scale effects, see, for example, {% cite 'Flock 2020a' '51, 55' %}; {% cite 'Flock et al. 2021a' %}; {% cite 'Flock et al. 2021b' %}; and {% cite 'Flock 2014' '130–39' %}.
