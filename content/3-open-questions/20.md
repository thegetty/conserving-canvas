...
The use of these aqueous materials, as well as the need to minimize lining defects such as weave interference and moating (that is, no alteration of the structural character of the painting), dictated the development of a suction table, and in 1975, Mehra published the design of a table to dry the painting under controllable low pressure. The function of the table is predicated upon high airflow capabilities, and thus required a significant plenum, which is covered by a perforated sheet of metal. The airflow is controlled by varying both the blower speed and by opening and closing the bleeder vents at one end of the table. The table thus has directional flow, the air being brought in one end of the table and out the other. On the surface of the perforated sheet is an open cell polyurethane sheet that can conform to the topography of the rear of the painting, although not too readily.
