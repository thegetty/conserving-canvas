...
{% figuregroup '3' 'fig-49-1-a, fig-49-1-b, fig-49-1-c' '(a) Initial test areas with Evolon CR tissue and solvent on the verso of a painting following wax-lining reversal. (b) Applying 1 mL of solvent to Evolon CR tissue. &#40;c) Removal of Evolon CR after prescribed dwell time. Images: Julianna Ly' %}
...
{% figuregroup '2' 'fig-49-4-a, fig-49-4-b, fig-49-4-c, fig-49-4-d' 'SEM BSE images of unused tissue: (a) control, (b) after iteration 1, &#40;c) after iteration 2, (d) after iteration 3. (Surface morphology changes visualized in SEM BSE images captured at 137× by Dr. Judy Rudolph, volunteer conservation scientist, SRAL, Winterthur Museum.) Images: Judy Rudolph' %}
