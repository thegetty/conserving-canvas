...
During the last decades, the criterion of minimal intervention has acquired great importance and continues to guide the actions of conservative practitioners aiming to keep open options for retreatment ([[Appelbaum 1987]]). In the specific field of painted canvas supports, progress has been constant as a result of the search for new operational methodologies that continue to provide better responses to the problem of deterioration. Neodymium magnets have a wide field of application in the assembly of objects in permanent and temporary exhibitions, especially graphic works, textiles, and decorative arts collections ([[Spicer 2019]]), but specific applications for pictorial works are still scarce ([[Bestetti 2005]]; {% cite 'Rella and Saccani 2006' '17–19' %}; [[Sterp Moga and Sánchez Ortiz 2019]]) .
