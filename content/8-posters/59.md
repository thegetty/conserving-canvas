...
{% figure 'fig-59-1' 'pdf-two-column' %}
...
{% figuregroup '3' 'fig-59-2-a, fig-59-2-b, fig-59-2-c' '**Figure 59.2** (a) Thread-by-thread suture. (b) Textile intarsia. &#40;c) Reinforcement with thread bridges. Image: Emanuel Sterp Moga' 'pdf-two-column' %}
...
{% figure 'fig-59-3' 'pdf-two-column' %}
