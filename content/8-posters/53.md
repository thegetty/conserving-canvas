...
The lining adhesive consisted of 70% Dispersion K 360 (pH adjusted with ammonium hydroxide), 30% Plextol D540, thickened with Rohagit SD 15, all v/v. Plextol acrylic dispersion products have been used for lining since the 1970s, and extensive research has established their aging properties ({% cite 'Down 1996' %}; {% cite 'de Witte, Florquin, and Goessens-Landrie 1984' %}; {% cite 'Mehra 1984' %}). However, these products are subject to market influences and, thus, since the product formulations and availability have changed, the reported results may no longer be valid for products mentioned in this essay.[^7]
