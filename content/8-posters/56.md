...
Double-sided painted textiles have been used since ancient times in the Orthodox Church during processions, ecclesiastic feasts, and litanies. The identity of double-sided painted canvases with ritual function marks a particular chapter of challenges for painting conservators, starting from the cultural perspective and extending to the very specific technical aspects that define such complex objects, defined typologically as paintings on canvas or as painted textiles ({% cite 'Pollak 2003' %}).
...
{% figure 'table-56-3' 'is-table-scale-5' %}
...
[^11]: The adhesive and cohesive properties of Beva are assessed in depth, compared to other conservation products ({% cite 'Mecklenburg, Fuster-Lopez, and Ottoloni 2012' %}).
