...
abstract: "Today the collection of the Neue Pinakothek in Munich comprises a collection inaugurated by King Ludwig I of Bavaria in 1853, which has continued to grow, while the Collection Schack, consisting of over 250 paintings purchased directly from the artists in the second half of the nineteenth century, has remained intact. The collection of the Neue Pinakothek has received more interactive treatment in line with the developing approaches to conservation in the twentieth century, while the Schack collection has received minimal treatment, with a large proportion remaining relatively untouched. In response to today’s more minimal approach to conservation treatments and with increasing emphasis on preventive care, the digitization of the institution’s conservation records afforded the opportunity to assess the effects of various treatments over time. Sufficient data were provided for an analysis of more than 1,700 paintings as well as the overview of a conservator who has worked with the collections for over twenty-five years."
---
...
{% figure 'fig-32-3' 'pdf-two-column' %}
...
{% figure 'fig-32-4' 'pdf-two-column' %}

{% figure 'fig-32-5' 'pdf-two-column' %}
...
-   None of the marouflages can be definitively dated. The same applies to a large number of the linings; 60% of the wax-linings but only 19% of the paste-linings can be classified by date. The first documented wax-lining took place in 1952, with the first recorded use of a heating table in 1965.[^10] The years leading up to the last documented wax-lining—carried out in 1976, shortly after the Greenwich conference—mark the heyday of this method. The fact that this period coincides with a general increase in documentation explains why the number of unreported cases of wax-linings is lower than that of paste-linings. Paste was also used to line paintings during and after the boom in wax treatments, recorded for the last time in 1995.[^11] The exact formulation of the adhesive or a description of the working method is very rarely provided.[^12]
...
[^9]: *Paste* and *wax* are the usual collective terms, although mixtures were generally used; see note 12 below.

[^10]: The first heated vacuum table was acquired in 1959 ({% cite 'Wolters 1960' %}).

[^11]: The Doerner Institut still possesses a veneer press used for paste-linings in the paste.
...
[^14]: Calaton CB, manufactured by ICI, United Kingdom.
...
[^17]: We have my predecessor Konrad Laudenbacher to thank for this collection of around fifty stretchers.
